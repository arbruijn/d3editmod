...
object *CreateSubobjectDebrisDirected(object *parent, int subobj_num,vector *dir,float explosion_mag,int death_flags
#ifdef __cplusplus
=DF_DEBRIS_SMOKES
#endif
);
...
void DrawColoredDisk (vector *pos,float r,float g,float b,float inner_alpha,float outer_alpha,float size,ubyte saturate
#ifdef __cplusplus
=0
#endif
,ubyte lod
...
void DrawColoredRing (vector *pos,float r,float g,float b,float inner_alpha,float outer_alpha,float size,float inner_ring_ratio,ubyte saturate
#ifdef __cplusplus
=0
#endif
,ubyte lod
