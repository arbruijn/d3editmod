...
extern small_point *World_point_buffer;	// Rotated points
...
extern void ResetTerrain(int force
#ifdef __cplusplus
=0
#endif
);
...
extern void DisplayTerrainList (int,bool from_automap
#ifdef __cplusplus
=0
#endif
);
...
void RenderTerrain(ubyte from_mine,int left
#ifdef __cplusplus
=-1
#endif
,int top
...
void GetPreRotatedPoint (vector *,int,int,int);
