...
void DrawPolygonModel(vector *pos,matrix *orient,int model_num,float *normalized_time,int flags,float r,float g,float b, uint f_render_sub
#ifdef __cplusplus
 = 0xFFFFFFFF
#endif 
,ubyte use_effect
...
void DrawPolygonModel(vector *pos,matrix *orient,int model_num,float *normalized_time,int flags,vector *lightdir,float r,float g,float b, uint f_render_sub
#ifdef __cplusplus
=0xFFFFFFFF
#endif
,ubyte use_effect
...
void DrawPolygonModel(vector *pos,matrix *orient,int model_num,float *normalized_time,int flags,lightmap_object *lm_object, uint f_render_sub,ubyte use_effect
#ifdef __cplusplus
=0
#endif
,ubyte overlay
...
// Rendering functions
int RenderPolygonModel (poly_model *, uint f_render_sub
#ifdef __cplusplus
 = 0xFFFFFFFF
#endif
);
...
void PageInPolymodel (int polynum, int type
#ifdef __cplusplus
 = -1
#endif 
 , float *size_ptr
