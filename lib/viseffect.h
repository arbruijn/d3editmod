...
void CreateRandomSparks (int num_sparks,vector *pos,int roomnum,int which_index
#ifdef __cplusplus
=-1
#endif
,float force_scalar
...
void CreateRandomLineSparks (int num_sparks,vector *pos,int roomnum,ushort color
#ifdef __cplusplus
=0
#endif
,float force_scalar
...
int VisEffectCreateControlled(ubyte type,object *parent,ubyte id,int roomnum,vector *pos,float lifetime,vector *velocity,int phys_flags
#ifdef __cplusplus
=0
#endif
,float size
