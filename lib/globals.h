...
#ifdef NEWEDITOR
void PrintToDlgItem(CDialog *dlg,int id,const char *fmt,...);
#endif
...
void ned_SetupSearchPaths(const char *base_dir);
...
int FindTextureName(const char *p);
int FindDoorName(const char *p);
