...
class oeApplication;
#else
typedef struct oeApplication oeApplication;
#endif
...
void rend_DrawScaledBitmap (int x1,int y1,int x2,int y2,int bm,float u0,float v0,float u1,float v1,float zval,int color
#ifdef __cplusplus
=-1
#endif
,float *alphas
