...
#undef GO
		...
		CASE _66_0x1E :                      /* PUSH DS */
		Push16(emu, emu->segs[_DS]);
		NEXT;
		CASE _66_0x1F :                      /* POP DS */
		...
		CASE _66_0x26 :                      /* ES: */
			// ignored
		opcode = F8;
		goto switch_opcodes66; //goto* opcodes66[opcode];
		CASE _66_0x2E :                      /* CS: */
			// ignored
		opcode = F8;
		goto switch_opcodes66; //goto* opcodes66[opcode];
		...
		CASE _66_0x68 :                       /* PUSH u16 */
		tmp16u = F16;
		Push16(emu, tmp16u);
		NEXT;
		CASE _66_0x69 :                      /* IMUL Gw,Ew,Iw */
		nextop = F8;
		GET_EW;
		tmp16u = F16;
		GW.word[0] = imul16(emu, EW->word[0], tmp16u);
		NEXT;
		CASE _66_0x6A :                      /* PUSH Ib (as signed word) */
		tmp16s = F8S;
		Push16(emu, (uint16_t)tmp16s);
		NEXT;
		CASE _66_0x6B :                      /* IMUL Gw,Ew,Ib */
		nextop = F8;
		GET_EW;
		tmp16s = F8S;
		...
		CASE _66_0x81 :                              /* GRP3 Ew,Iw */
		CASE _66_0x83 :                              /* GRP3 Ew,Ib */
		nextop = F8;
		GET_EW;
		if (opcode == 0x81)
			tmp16u = F16;
		...
		CASE _66_0x85 :                              /* TEST Ew,Gw */
		nextop = F8;
		GET_EW;
		test16(emu, EW->word[0], GW.word[0]);
		NEXT;

		CASE _66_0x87 :                              /* XCHG Ew,Gw */
		nextop = F8;
		GET_EW;
		tmp16u = GW.word[0];
		GW.word[0] = EW->word[0];
		...
		CASE _66_0x89 :                              /* MOV Ew,Gw */
		nextop = F8;
		GET_EW;
		EW->word[0] = GW.word[0];
		NEXT;

		CASE _66_0x8B :                              /* MOV Gw,Ew */
		nextop = F8;
		GET_EW;
		GW.word[0] = EW->word[0];
		NEXT;
		CASE _66_0x8C :                              /* MOV Ew,Seg */
		nextop = F8;
		GET_EW;
		EW->word[0] = emu->segs[(nextop & 0x38) >> 3];
		NEXT;

		CASE _66_0x8E :                               /* MOV Seg,Ew */
		nextop = F8;
		GET_EW;
		emu->segs[((nextop & 0x38) >> 3)] = EW->word[0];
		emu->segs_serial[((nextop & 0x38) >> 3)] = 0;
		NEXT;
		CASE _66_0x8F :                              /* POP Ew */
		nextop = F8;
		GET_EW;
		EW->word[0] = Pop16(emu);
		NEXT;
		...
		*(uint16_t*)(BASE+R_EDI) = R_AX;
		...
		CASE _66_0xB8 :                              /* MOV AX,Iw */
		CASE _66_0xB9 :                              /* MOV CX,Iw */
		CASE _66_0xBA :                              /* MOV DX,Iw */
		CASE _66_0xBB :                              /* MOV BX,Iw */
		CASE _66_0xBC :                              /*    ...     */
		CASE _66_0xBD :
		CASE _66_0xBE :
		CASE _66_0xBF :
		...
		CASE _66_0xC7 :                              /* MOV Ew,Iw */
		nextop = F8;
		GET_EW;
		EW->word[0] = F16;
		NEXT;

		CASE _66_0xCB :                               /* FAR RET */
		ip = Pop(emu);
		...
		STEP
			NEXT;
		CASE _66_0xD1 :                              /* GRP2 Ew,1  */
		CASE _66_0xD3 :                              /* GRP2 Ew,CL */
		nextop = F8;
		GET_EW;
		...
		CASE _66_0xF2 :                      /* REPNZ prefix */
		CASE _66_0xF3 :                      /* REPZ prefix */
		nextop = F8;
		tmp8s = ACCESS_FLAG(F_DF) ? -2 : +2;
		tmp32u = R_ECX;
		switch (nextop) {
