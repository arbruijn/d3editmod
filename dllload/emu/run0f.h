	...
	switch (opcode) {
        ...
        CASE _0f_0x10:                      /* MOVUPS Gx,Ex */
            nextop = F8;
            GET_EX;
            memcpy(&GX, EX, 16); // unaligned, so carreful
            NEXT;
        CASE _0f_0x11:                      /* MOVUPS Ex,Gx */
            nextop = F8;
            GET_EX;
        ...
        CASE _0f_0x12:                      
            ...
            NEXT;
        CASE _0f_0x13:                      /* MOVLPS Ex,Gx */
            nextop = F8;
            GET_EX;
            EX->q[0] = GX.q[0];
            NEXT;
        CASE _0f_0x14:                      /* UNPCKLPS Gx, Ex */
            nextop = F8;
            GET_EX;
            GX.ud[3] = EX->ud[1];
            GX.ud[2] = GX.ud[1];
        ...
        CASE _0f_0x15:                      /* UNPCKHPS Gx, Ex */
            ...
            GX.ud[3] = EX->ud[3];
            NEXT;
        CASE _0f_0x16:                      /* MOVHPS Gx,Ex */
            nextop = F8;               /* MOVLHPS Gx,Ex (Ex==reg) */
            GET_EX;
            GX.q[1] = EX->q[0];
            NEXT;
        CASE _0f_0x17:                      /* MOVHPS Ex,Gx */
            nextop = F8;
            GET_EX;
            EX->q[0] = GX.q[1];
            NEXT;
        CASE _0f_0x18:                       /* PREFETCHh Ed */
            nextop = F8;
            GET_ED;
			#ifdef __GNUC__
            if((nextop&0xC0)==0xC0) {
        ...
        CASE _0f_0x1A:                      /* NOP (multi-byte) / ignored BNDLDX */
            nextop = F8;
            GET_ED;
            NEXT;
        CASE _0f_0x1B:                      /* NOP (multi-byte) / ignored BNDSTX */
            nextop = F8;
            GET_ED;
            NEXT;

        CASE _0f_0x1F:                      /* NOP (multi-byte) */
            nextop = F8;
            GET_ED;
            NEXT;

        CASE _0f_0x28:                      /* MOVAPS Gx,Ex */
            nextop = F8;
            GET_EX;
            GX.q[0] = EX->q[0];
            GX.q[1] = EX->q[1];
            NEXT;
        CASE _0f_0x29:                      /* MOVAPS Ex,Gx */
            nextop = F8;
            GET_EX;
            EX->q[0] = GX.q[0];
            EX->q[1] = GX.q[1];
            NEXT;
        CASE _0f_0x2A:                      /* CVTPI2PS Gx, Em */
            nextop = F8;
            GET_EM;
            GX.f[0] = EM->sd[0];
            GX.f[1] = EM->sd[1];
            NEXT;
        CASE _0f_0x2B:                      /* MOVNTPS Ex,Gx */
            nextop = F8;
            GET_EX;
            EX->q[0] = GX.q[0];
            EX->q[1] = GX.q[1];
            NEXT;
        CASE _0f_0x2C:                      /* CVTTPS2PI Gm, Ex */
            nextop = F8;
            GET_EX;
            GM.sd[1] = EX->f[1];
            GM.sd[0] = EX->f[0];
            NEXT;
        CASE _0f_0x2D:                      /* CVTPS2PI Gm, Ex */
            ...
            NEXT;
        CASE _0f_0x2E:                      /* UCOMISS Gx, Ex */
            // same for now
        CASE _0f_0x2F:                      /* COMISS Gx, Ex */
            RESET_FLAGS(emu);
            nextop = F8;
            GET_EX;
        ...
        CASE _0f_0x38:  // these are some SSE3 opcodes
            opcode = F8;
            switch(opcode) {
                case 0x00:  /* PSHUFB */
                    nextop = F8;
        ...
        CASE _0f_0x50:                      /* MOVMSKPS Gd, Ex */
            ...
            NEXT;
        CASE _0f_0x51:                      /* SQRTPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] = sqrtf(EX->f[i]);
            NEXT;
        CASE _0f_0x52:                      /* RSQRTPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i) {
                if(EX->f[i]==0)
            ...
            NEXT;
        CASE _0f_0x53:                      /* RCPPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] = 1.0f/EX->f[i];
            NEXT;
        CASE _0f_0x54:                      /* ANDPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.ud[i] &= EX->ud[i];
            NEXT;
        CASE _0f_0x55:                      /* ANDNPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.ud[i] = (~GX.ud[i]) & EX->ud[i];
            NEXT;
        CASE _0f_0x56:                      /* ORPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.ud[i] |= EX->ud[i];
            NEXT;
        CASE _0f_0x57:                      /* XORPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.ud[i] ^= EX->ud[i];
            NEXT;
        CASE _0f_0x58:                      /* ADDPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] += EX->f[i];
            NEXT;
        CASE _0f_0x59:                      /* MULPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] *= EX->f[i];
            NEXT;
        CASE _0f_0x5A:                      /* CVTPS2PD Gx, Ex */
            nextop = F8;
            GET_EX;
            GX.d[1] = EX->f[1];
            GX.d[0] = EX->f[0];
            NEXT;
        CASE _0f_0x5B:                      /* CVTDQ2PS Gx, Ex */
            nextop = F8;
            GET_EX;
            GX.f[0] = EX->sd[0];
            GX.f[1] = EX->sd[1];
            ...
            GX.f[3] = EX->sd[3];
            NEXT;
        CASE _0f_0x5C:                      /* SUBPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] -= EX->f[i];
            NEXT;
        CASE _0f_0x5D:                      /* MINPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i) {
            ...
            NEXT;
        CASE _0f_0x5E:                      /* DIVPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i)
                GX.f[i] /= EX->f[i];
            NEXT;
        CASE _0f_0x5F:                      /* MAXPS Gx, Ex */
            nextop = F8;
            GET_EX;
            for(int i=0; i<4; ++i) {
        ...
        CASE _0f_0x61:                      /* PUNPCKLWD Gm, Em */
            ...
            GM.uw[1] = EM->uw[0];
            NEXT;
        CASE _0f_0x62:                      /* PUNPCKLDQ Gm, Em */
            nextop = F8;
            GET_EM;
            GM.ud[1] = EM->ud[0];
            NEXT;
        CASE _0f_0x63:                      /* PACKSSWB Gm, Em */
            nextop = F8;
            GET_EM;
        ...
        CASE _0f_0x6E:                      /* MOVD Gm, Ed */
            nextop = F8;
            GET_ED;
            GM.q = ED->dword[0];    // zero extended
            NEXT;
        CASE _0f_0x6F:                      /* MOVQ Gm, Em */
            nextop = F8;
            GET_EM;
            GM.q = EM->q;
            NEXT;
        CASE _0f_0x70:                       /* PSHUFW Gm, Em, Ib */
            nextop = F8;
            GET_EM;
            tmp8u = F8;
            if(EM==&GM) {eam1 = GM; EM = &eam1;}   // copy is needed
        ...
        CASE _0f_0x7E:                       /* MOVD Ed, Gm */
            nextop = F8;
            GET_ED;
            ED->dword[0] = GM.ud[0];
            NEXT;
        CASE _0f_0x7F:                      /* MOVQ Em, Gm */
            nextop = F8;
            GET_EM;
            EM->q = GM.q;
            NEXT;

        CASE _0f_0xA0:                      /* PUSH FS */
            Push(emu, emu->segs[_FS]);    // even if a segment is a 16bits, a 32bits push/pop is done
            NEXT;
        CASE _0f_0xA1:                      /* POP FS */
        ...
        CASE _0f_0xA3:                      /* BT Ed,Gd */
            ...
            if(ED->dword[0] & (1<<tmp8u))
                ...
                CLEAR_FLAG(F_CF);
            NEXT;
        CASE _0f_0xA4:                      /* SHLD Ed,Gd,Ib */
        CASE _0f_0xA5:                      /* SHLD Ed,Gd,CL */
            nextop = F8;
            GET_ED;
        ...
        CASE _0f_0xAB:                      /* BTS Ed,Gd */
            ...
            NEXT;
        CASE _0f_0xAC:                      /* SHRD Ed,Gd,Ib */
        CASE _0f_0xAD:                      /* SHRD Ed,Gd,CL */
            nextop = F8;
            GET_ED;
        ...
        CASE _0f_0xAE:                      /* Grp Ed (SSE) */
            ...
            NEXT;
        CASE _0f_0xAF:                      /* IMUL Gd,Ed */
            nextop = F8;
            GET_ED;
            GD.dword[0] = imul32(emu, GD.dword[0], ED->dword[0]);
            NEXT;
        CASE _0f_0xB0:                      /* CMPXCHG Eb,Gb */
            nextop = F8;
            GET_EB;
        ...
        CASE _0f_0xB6:                      /* MOVZX Gd,Eb */
            nextop = F8;
            GET_EB;
            GD.dword[0] = EB->byte[0];
            NEXT;
        CASE _0f_0xB7:                      /* MOVZX Gd,Ew */
            nextop = F8;
            GET_EW;
        ...
        CASE _0f_0xBD:                      /* BSR Ed,Gd */
            ...
            NEXT;
        CASE _0f_0xBE:                      /* MOVSX Gd,Eb */
            nextop = F8;
            GET_EB;
            GD.sdword[0] = EB->sbyte[0];
            NEXT;
        CASE _0f_0xBF:                      /* MOVSX Gd,Ew */
            nextop = F8;
            GET_EW;
            GD.sdword[0] = EW->sword[0];
            NEXT;

        CASE _0f_0xC0:                      /* XADD Gb,Eb */
            nextop = F8;
            GET_EB;
        ...
        CASE _0f_0xC2:                      /* CMPPS Gx, Ex, Ib */
            ...
            NEXT;
        CASE _0f_0xC3:                       /* MOVNTI Ed,Gd */
            nextop = F8;
            GET_ED;
            ED->dword[0] = GD.dword[0];
            NEXT;
        CASE _0f_0xC4:                       /* PINSRW Gm,Ew,Ib */
            nextop = F8;
            GET_ED;
            tmp8u = F8;
            GM.uw[tmp8u&3] = ED->word[0];   // only low 16bits
            NEXT;
        CASE _0f_0xC5:                       /* PEXTRW Gw,Em,Ib */
            nextop = F8;
            GET_EM;
            tmp8u = F8;
            GD.dword[0] = EM->uw[tmp8u&3];  // 16bits extract, 0 extended
            NEXT;
        CASE _0f_0xC6:                      /* SHUFPS Gx, Ex, Ib */
            nextop = F8;
            GET_EX;
            tmp8u = F8;
            for(int i=0; i<2; ++i) {
...
#define __builtin_bswap32(x) _byteswap_ulong(x)
        ...
        CASE _0f_0xD2:                   /* PSRLD Gm,Em */
            ...
            NEXT;
        CASE _0f_0xD3:                   /* PSRLQ Gm,Em */
            nextop = F8;
            GET_EM;
            GM.q = (EM->q > 63) ? 0 : (GM.q >> EM->q);
            NEXT;
        CASE _0f_0xD4:                   /* PADDQ Gm,Em */
            nextop = F8;
            GET_EM;
            GM.sq += EM->sq;
            NEXT;
        CASE _0f_0xD5:                   /* PMULLW Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<4; ++i) {
        ...
        CASE _0f_0xD9:                   /* PSUBUSW Gm,Em */
            ...
            NEXT;
        CASE _0f_0xDA:                   /* PMINUB Gm,Em */
            nextop = F8;
            GET_EM;
            for (int i=0; i<8; ++i)
                GM.ub[i] = (GM.ub[i]<EM->ub[i])?GM.ub[i]:EM->ub[i];
            NEXT;
        CASE _0f_0xDB:                   /* PAND Gm,Em */
            nextop = F8;
            GET_EM;
            GM.q &= EM->q;
            NEXT;
        CASE _0f_0xDC:                   /* PADDUSB Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<8; ++i) {
        ...
        CASE _0f_0xDD:                   /* PADDUSW Gm,Em */
            ...
            NEXT;
        CASE _0f_0xDE:                   /* PMAXUB Gm,Em */
            nextop = F8;
            GET_EM;
            for (int i=0; i<8; ++i)
                GM.ub[i] = (GM.ub[i]>EM->ub[i])?GM.ub[i]:EM->ub[i];
            NEXT;
        CASE _0f_0xDF:                   /* PANDN Gm,Em */
            nextop = F8;
            GET_EM;
            GM.q = (~GM.q) & EM->q;
            NEXT;
        CASE _0f_0xE0:                   /* PAVGB Gm, Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<8; ++i)
                    GM.ub[i] = ((uint32_t)GM.ub[i]+EM->ub[i]+1)>>1;
            NEXT;
        CASE _0f_0xE1:                   /* PSRAW Gm, Em */
            nextop = F8;
            GET_EM;
            if(EM->q>15)
                tmp8u = 16;
        ...
        CASE _0f_0xE2:                   /* PSRAD Gm, Em */
            ...
            NEXT;
        CASE _0f_0xE3:                   /* PAVGW Gm, Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<4; ++i)
                GM.uw[i] = ((uint32_t)GM.uw[i]+EM->uw[i]+1)>>1;
            NEXT;
        CASE _0f_0xE4:                   /* PMULHUW Gm, Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<4; ++i) {
                tmp32u = (uint32_t)GM.uw[i] * EM->uw[i];
        ...
        CASE _0f_0xE9:                   /* PSUBSW Gm,Em */
            ...
            NEXT;
        CASE _0f_0xEA:                   /* PMINSW Gm,Em */
            nextop = F8;
            GET_EM;
            for (int i=0; i<4; ++i)
                GM.sw[i] = (GM.sw[i]<EM->sw[i])?GM.sw[i]:EM->sw[i];
            NEXT;
        CASE _0f_0xEB:                   /* POR Gm, Em */
            nextop = F8;
            GET_EM;
            GM.q |= EM->q;
            NEXT;
        CASE _0f_0xEC:                   /* PADDSB Gm, Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<8; ++i) {
                tmp32s = (int32_t)GM.sb[i] + EM->sb[i];
        ...
        CASE _0f_0xED:                   /* PADDSW Gm, Em */
            ...
            NEXT;
        CASE _0f_0xEE:                   /* PMAXSW Gm,Em */
            nextop = F8;
            GET_EM;
            for (int i=0; i<4; ++i)
                GM.sw[i] = (GM.sw[i]>EM->sw[i])?GM.sw[i]:EM->sw[i];
            NEXT;
        CASE _0f_0xEF:                   /* PXOR Gm, Em */
            nextop = F8;
            GET_EM;
            GM.q ^= EM->q;
            NEXT;

        CASE _0f_0xF1:                   /* PSLLW Gm, Em */
            nextop = F8;
            GET_EM;
            if(EM->q>15)
                GM.q = 0;
        ...
        CASE _0f_0xF2:                   /* PSLLD Gm, Em */
            ...
            NEXT;
        CASE _0f_0xF3:                   /* PSLLQ Gm, Em */
            nextop = F8;
            GET_EM;
            GM.q = (EM->q > 63) ? 0 : (GM.q << EM->ub[0]);
            NEXT;
        CASE _0f_0xF4:                   /* PMULUDQ Gm,Em */
            nextop = F8;
            GET_EM;
            GM.q = (uint64_t)GM.ud[0] * (uint64_t)EM->ud[0];
            NEXT;
        CASE _0f_0xF5:                   /* PMADDWD Gm, Em */
            nextop = F8;
            GET_EM;
            for (int i=0; i<2; ++i) {
                int offset = i * 2;
        ...
        CASE _0f_0xF7:                   /* MASKMOVQ Gm, Em */
            ...
            if((nextop&0xC0)==0xC0) {
                ...
                goto _default;
            NEXT;
        CASE _0f_0xF8:                   /* PSUBB Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<8; ++i)
                GM.sb[i] -= EM->sb[i];
            NEXT;
        CASE _0f_0xF9:                   /* PSUBW Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<4; ++i)
                GM.sw[i] -= EM->sw[i];
            NEXT;
        CASE _0f_0xFA:                   /* PSUBD Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<2; ++i)
                GM.sd[i] -= EM->sd[i];
            NEXT;
        CASE _0f_0xFB:                   /* PSUBQ Gm,Em */
            nextop = F8;
            GET_EM;
            GM.sq -= EM->sq;
            NEXT;
        CASE _0f_0xFC:                   /* PADDB Gm, Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<8; ++i)
                GM.sb[i] += EM->sb[i];
            NEXT;
        CASE _0f_0xFD:                   /* PADDW Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<4; ++i)
                GM.sw[i] += EM->sw[i];
            NEXT;
        CASE _0f_0xFE:                   /* PADDD Gm,Em */
            nextop = F8;
            GET_EM;
            for(int i=0; i<2; ++i)
                GM.sd[i] += EM->sd[i];
