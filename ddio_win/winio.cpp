...
//	Initialize DirectInput subsystem
	...
	if(obj->NT()){
		...
		dires = DirectInput8Create((HINSTANCE)obj->m_hInstance, 0x0300, IID_IDirectInput8A, (LPVOID *)&lpdi, NULL);
		...
		//we require DX6
		dires = DirectInput8Create((HINSTANCE)obj->m_hInstance, DIRECTINPUT_VERSION, IID_IDirectInput8A, (LPVOID *)&lpdi, NULL);
