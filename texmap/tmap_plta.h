 ...
 */
			...
			__asm 
			{
				...
				HereMe:
					...
					cmp		bl,0						; transparent?
					je      nextpixel1					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel2					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel3					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel4					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel5					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel6					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel7					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					...
					cmp		bl,0						; transparent?
					je      nextpixel8					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
				...
				LeftoverLoop:
					...
					cmp		bl,0						; transparent?
					je      nextpixel9					; if so, don't draw
					mov     eax, Current_tex_palette	; get base of fade table	
					mov     bh, ch						; get light value in bh
					mov     eax,[eax+ebx*2]				; get texel
					mov     [edi], ax					; write out texel
