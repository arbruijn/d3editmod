...
#else
#include <SDL.h>
#define dwglGetProcAddress SDL_GL_GetProcAddress
#endif
...
#define dglActiveTextureARB glActiveTextureARB
#define dglClientActiveTextureARB glClientActiveTextureARB
#define dglMultiTextCoord4f glMultiTextCoord4f
#else
